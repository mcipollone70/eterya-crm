...
interface ServiceTicketFiltersBarProps {
...
export function ServiceTicketFiltersBar({ agents, companies }: ServiceTicketFiltersBarProps) {
  ...
  function updateParam(key: string, value: string) {
    ...
    startTransition(() => {
      router.push(`/assistenza?${params.toString()}`);
    });
  }
