        ...
        >
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              disabled={index === 0}
              className="inline-flex h-8 items-center rounded-lg border border-slate-200 px-2 text-xs font-medium text-slate-700 hover:bg-slate-50 disabled:opacity-40"
            >
