...
export type JoyCopilotToastVariant = "success" | "error";

interface JoyCopilotToastProps {
  message: string;
  variant: JoyCopilotToastVariant;
  onDismiss: () => void;
}

export function JoyCopilotToast({ message, variant, onDismiss }: JoyCopilotToastProps) {
  useEffect(() => {
