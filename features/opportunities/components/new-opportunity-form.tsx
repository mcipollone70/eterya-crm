    ...
    <form onSubmit={handleSubmit} className="space-y-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="block text-sm sm:col-span-2">
          ...
          <span className="mt-1 block text-xs text-slate-500">Tieni premuto Ctrl per selezionare più prodotti.</span>
        </label>
        ...
        <label className="block text-sm">
          ...
          <input type="date" name="expected_close_at" className="w-full rounded-lg border border-slate-200 px-3 py-2" />
        </label>

        <label className="block text-sm">
          <span className="mb-1 block font-medium text-slate-700">Fase iniziale</span>
          <select name="stage" defaultValue="new" disabled className="w-full rounded-lg border border-slate-200 bg-slate-100 px-3 py-2">
